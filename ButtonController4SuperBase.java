package Ting.payablesys.employee.buttoncontroller;
...
import Ting.payablesys.employeetype.earningbook.BasePlusCommissionEmployeeBook;
import Ting.payablesys.employeetype.earningbook.EmployeeBaseBook;
import Ting.payablesys.employeetype.frame.EmployeeBaseJFrame_V4;
...
public /* abstract */ class ButtonController4SuperBase {
	...
	EmployeeBaseJFrame_V4 frameEmployee;
	...
	public ButtonController4SuperBase(EmployeeBaseJFrame_V4 component, JDesktopPane _theDesktop) {
	...
	public void clickBtnToSetProfile() {
		if(helper.isReadFile)
		{
			...
			if(checkBasicProfile) {
				frameEmployee.helper4Employee.enableProfileTextBoxs(false);
				setProFile();
	...
	public void setProFile() {
		employeeBook = frameEmployee.setBasics2StarBookingEmployee();
	} //end setProfile
